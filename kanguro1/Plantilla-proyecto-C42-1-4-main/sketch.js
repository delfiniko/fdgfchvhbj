...
function setup() {
  ...
  puntos = createSprite(50,320,20,50);
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    puntos.velocityY = puntos.velocityY + 0.8
    spawnShrubs();
    spawnObstacles();

    kangaroo.collide(invisibleGround);
    puntos.collide(invisibleGround);
    ...
    if(puntos.isTouching(obstaclesGroup)){
      puntos.y = puntos.y - 100
      score = score + 1;
